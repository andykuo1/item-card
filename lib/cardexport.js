...
function build(modelPath, modelRes, inputPath, layoutPath, outputPath, resourceDirectory)
{
  ...
  let tempPath = outputPath + '/' + INTERMEDIATES;
  let lstat = fs.lstatSync(inputPath);
  clearDirectory(outputPath);

  copyLooseResources('.js', modelRes + '/js', tempPath + '/js');
  copyLooseResources('.css', modelRes + '/css', tempPath + '/css');
  copyLooseResources('.jpg', modelRes + '/img', tempPath + '/img');
  copyLooseResources('.png', modelRes + '/img', tempPath + '/img');
  copyLooseResources('.ttf', modelRes + '/font', tempPath + '/font');
...
function run()
{
  ...
  build(modelPath, modelRes, itemPath, layoutPath, outputPath, resourceDirectory);
}
